...
(function () {
    ...
    function D(a, c) {
        ...
        if (b = {
            ...
            }[a || "solid"])for (var d = 0; d < b.length; d++)b[d] *= c; else b = [];
        return b
    }

    function J(a,
               c, b, d) {
        if (a.addEventListener)a.addEventListener(c, b, d || !1); else if (a.attachEvent)a.attachEvent("on" + c, function (c) {
            c = c || window.event;
    ...
    function ma(a, c) {
        for (var b = [], d, e = 0; e < a.length; e++)if (0 == e)b.push(a[0]); else {
            var f, g, k;
            k = e - 1;
            f = 0 === k ? 0 : k - 1;
    ...
    function ga(a, c) {
        ...
        if (x(this._options.margin) && a._options.subtitles)for (var b = a._options.subtitles,
                                                                     d = 0; d < b.length; d++)if ((x(b[d].horizontalAlign) && "center" === this.horizontalAlign || b[d].horizontalAlign === this.horizontalAlign) && (x(b[d].verticalAlign) && "top" === this.verticalAlign || b[d].verticalAlign === this.verticalAlign) && !b[d].dockInsidePlotArea === !this.dockInsidePlotArea) {
            this.margin = 0;
            break
        }
    ...
    function F(a, c, b, d) {
        ...
        if (this._options.stripLines && 0 < this._options.stripLines.length)for (this.stripLines = [], c = 0; c < this._options.stripLines.length; c++)this.stripLines.push(new pa(this.chart, this._options.stripLines[c], a.theme, ++this.chart._eventManager.lastObjectId, this));
    ...
    var u = !!document.createElement("canvas").getContext, qa = {
            Chart: {
                width: 500,
                height: 400,
                zoomEnabled: !1,
        ...
        ca = {
            ...
            theme2: {
                ...
                Chart: {colorSet: "colorSet1"},
                Title: {
                    fontFamily: u ? "Candara, Optima, Trebuchet MS, Helvetica Neue, Helvetica, Trebuchet MS, serif" :
                        "calibri",
                    fontSize: 32,
                    fontColor: "#3A3A3A",
                    fontWeight: "bold",
            ...
            return function (k, q, h) {
                var n = h ? h.days : c, m = h ? h.months : d, l = h ? h.shortDays : b, p = h ? h.shortMonths : e;
                h = "";
                var r = !1;
                ...
                h = r ? "getUTC" : "get";
                var t = k[h + "Date"](), y = k[h + "Day"](),
                    s = k[h + "Month"](), z = k[h + "FullYear"](), w = k[h + "Hours"](), u = k[h + "Minutes"](), W = k[h + "Seconds"](), x = k[h + "Milliseconds"](), v = r ? 0 : k.getTimezoneOffset();
            ...
            c = String(c);
            var g = 1, k = b = "", q = -1, h = [], n = [], m = 0, l = 0, p = 0, r = !1, t = 0, k = c.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
            c = null;
            for (var y = 0; k && y < k.length; y++)if (c = k[y], "." === c && 0 > q)q = y; else {
                if ("%" === c)g *= 100; else if ("\u2030" === c) {
                    g *= 1E3;
                    continue
            ...
            "").split("");
            g && "0" === g[0] && g.shift();
            for (y = r = k = l = q = 0; 0 < h.length;)if (c = h.pop(), "#" === c || "0" === c)if (q++, q === m) {
                var s = g, g = [];
                if ("0" === c)for (c = m - l - (s ? s.length : 0); 0 < c;)s.unshift("0"), c--;
                for (; 0 < s.length;)b = s.pop() + b, y++, 0 === y % r && (k === p && 0 < s.length) && (b = f + b);
                d && (b = "-" + b)
            } else 0 < g.length ? (b = g.pop() + b, l++, y++) : "0" === c && (b = "0" + b, l++, y++), 0 === y % r && (k === p && 0 < g.length) && (b = f + b); else"E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? "," === c ? (k++, r = y, y = 0, 0 < g.length && (b = f + b)) : b = 1 < c.length &&
            ...
            return {x: c, y: b}
        }, Fa = !0, ta = window.devicePixelRatio || 1, ka = 1, N = Fa ? ta / ka : 1, Ma = {
    ...
    L.prototype.removeEventListener =
        function (a, c) {
            if (a && c && this._eventListeners[a])for (var b = this._eventListeners[a], d = 0; d < b.length; d++)if (b[d].eventHandler === c) {
                b[d].splice(d, 1);
                break
            }
        };
    ...
    v.prototype._updateOptions =
        function () {
            ...
            if ("undefined" === typeof qa.Chart.creditHref)this.creditHref = "http://wikiplag", this.creditText = "WikiPlag"; else var b = this.updateOption("creditText"), d = this.updateOption("creditHref");
    ...
    v.prototype._initialize = function () {
        ...
        this.data = [];
        var a = 0;
        if (this._options.data)for (var c = 0; c < this._options.data.length; c++)if (a++, !this._options.data[c].type || 0 <= v._supportedChartTypes.indexOf(this._options.data[c].type)) {
    ...
    v.prototype.render = function (a) {
        ...
        this._initialize();
        var c = [];
        for (a = 0; a < this.data.length; a++)if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement)this.data[a].axisYType && "primary" !== this.data[a].axisYType ? "secondary" === this.data[a].axisYType && (this.axisY2 || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2 = new F(this, this._options.axisY2, "axisY", "right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2 = new F(this,
        ...
        var b = !1;
        if (0 < this._axes.length && (this.zoomEnabled || this.panEnabled))for (a = 0; a < this._axes.length; a++)if (null !== this._axes[a].viewportMinimum ||
        ...
        if (this._options.subtitles)for (a = 0; a < this._options.subtitles.length; a++)this.subtitles = [], b = new na(this, this._options.subtitles[a]), this.subtitles.push(b),
        ...
        else if ("none" === this.plotInfo.axisPlacement)this.preparePlotArea(); else return;
        ...
        for (a = 0; a < this.plotInfo.plotTypes.length; a++)for (c = this.plotInfo.plotTypes[a], b = 0; b < c.plotUnits.length; b++) {
        ...
        0 < d.length ? (q.disableToolTip = !0, q._animator.animate(200, q.animationDuration, function (a) {
            ...
            d = [];
            for (var a = 0; a < q.plotInfo.plotTypes.length; a++)for (var b = q.plotInfo.plotTypes[a], c = 0; c < b.plotUnits.length; c++)b.plotUnits[c].targetCanvas =
                null;
            e = null;
            q.disableToolTip = !1
    ...
    v.prototype.categoriseDataSeries = function () {
        for (var a = "", c = 0; c < this.data.length; c++)if (a = this.data[c], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= v._supportedChartTypes.indexOf(a.type)) {
            for (var b = null, d = !1, e = null, f = !1, g = 0; g < this.plotInfo.plotTypes.length; g++)if (this.plotInfo.plotTypes[g].type === a.type) {
                d = !0;
                b = this.plotInfo.plotTypes[g];
                break
            }
            d || (b = {type: a.type, totalDataSeries: 0, plotUnits: []}, this.plotInfo.plotTypes.push(b));
            for (g = 0; g < b.plotUnits.length; g++)if (b.plotUnits[g].axisYType === a.axisYType) {
                f = !0;
                e = b.plotUnits[g];
                break
            }
        ...
        for (c = 0; c < this.plotInfo.plotTypes.length; c++)for (b =
    ...
    v.prototype._processMultiseriesPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f = !1, g = 0; g < a.dataSeriesIndexes.length; g++) {
            var k = this.data[a.dataSeriesIndexes[g]], q = 0, h = !1, n = !1, m;
            ...
            for (q = 0; q < k.dataPoints.length; q++) {
                ...
                if (d < l && !h)null !== e && (m = d); else {
                    if (!h && (h = !0, 0 < q)) {
                        q -= 2;
                        continue
                    }
                    if (d > p && !n)n = !0; else if (d > p && n)continue;
        ...
        function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f = !1, g = [], k = [], q = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++) {
                    var n = this.data[a.dataSeriesIndexes[h]], m = 0, l = !1, p = !1, r;
                    ...
                    for (m = 0; m < n.dataPoints.length; m++) {
                        ...
                        if (d < t && !l)null !== n.dataPoints[m].y && (r = d); else {
                            if (!l && (l = !0, 0 < m)) {
                                m -= 2;
                                continue
                            }
                            if (d > y && !p)p = !0; else if (d > y && p)continue;
    ...
    v.prototype._processStacked100PlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f = !1, g = !1, k = !1, q = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                var n =
                    this.data[a.dataSeriesIndexes[h]], m = 0, l = !1, p = !1, r;
    ...
    v.prototype._processMultiYPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f, g, k = !1, q = 0; q < a.dataSeriesIndexes.length; q++) {
            var h = this.data[a.dataSeriesIndexes[q]], n = 0, m = !1, l = !1, p, r, t;
            ...
            for (n = 0; n < h.dataPoints.length; n++) {
                ...
                if (!(d < y) || m) {
                    ...
                    if (d > s && !l)l = !0; else if (d > s && l)continue;
                    h.dataPoints[n].label && (a.axisX.labels[d] = h.dataPoints[n].label);
                    d < b.viewPortMin && (b.viewPortMin = d);
                    d > b.viewPortMax && (b.viewPortMax = d);
                    if (b.viewPortMin === d && e)for (z = 0; z < e.length; z++)if (null === e[z] && p < d) {
                        b.viewPortMin = p;
                        break
                    }
    ...
    v.prototype.getDataPointAtXY = function (a, c, b) {
        ...
        a = null;
        c = !1;
        for (b = 0; b < d.length; b++)if ("line" === d[b].dataSeries.type || "stepLine" === d[b].dataSeries.type || "area" === d[b].dataSeries.type || "stepArea" === d[b].dataSeries.type)if (e = R("markerSize", d[b].dataPoint, d[b].dataSeries) || 8, d[b].distance <=
            e / 2) {
            c = !0;
            break
        }
    ...
    v.prototype.getObjectAtXY = function (a, c, b) {
        var d = null;
        if (b = this.getDataPointAtXY(a, c, b || !1))d = b.dataSeries.dataPointIds[b.dataPointIndex]; else if (u)d = Ea(a, c, this._eventManager.ghostCtx); else for (b = 0; b < this.legend.items.length; b++) {
    ...
    v.prototype._touchEventHandler = function (a) {
        if (a.changedTouches && this.interactivityEnabled) {
            ...
            if (!(b && 1 < b.length)) {
                ...
                if (this._lastTouchData.scroll && this.zoomEnabled)this.isDrag && this.resetOverlayedCanvas(), this.isDrag = !1; else for (b = 0; b < c.length; b++)e = c[b], f = document.createEvent("MouseEvent"), f.initMouseEvent(e,
    ...
    v.prototype._mouseEventHandler = function (a) {
        ...
        if (this.interactivityEnabled)if (this._ignoreNextEvent)this._ignoreNextEvent = !1; else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), !e) {
            if (!v.capturedEventParam && this._events) {
                for (var f = 0; f < this._events.length; f++)if (this._events[f].hasOwnProperty(b))if (d = this._events[f], e = d.bounds, c.x >=
    ...
    v.prototype._plotAreaMouseUp = function (a, c) {
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            var b = c -
                this.dragStartPoint.y, d = a - this.dragStartPoint.x, e = 0 <= this.zoomType.indexOf("x"), f = 0 <= this.zoomType.indexOf("y"), g = !1;
            this.resetOverlayedCanvas();
            if ("xySwapped" === this.plotInfo.axisPlacement)var k = f, f = e, e = k;
            if (this.panEnabled || this.zoomEnabled) {
                if (this.panEnabled)for (e = f = 0; e < this._axes.length; e++)b = this._axes[e], b.viewportMinimum < b.minimum ? (f = b.minimum - b.viewportMinimum, b.sessionVariables.newViewportMinimum = b.viewportMinimum + f, b.sessionVariables.newViewportMaximum = b.viewportMaximum + f, g = !0) : b.viewportMaximum >
                b.maximum && (f = b.viewportMaximum - b.maximum, b.sessionVariables.newViewportMinimum = b.viewportMinimum - f, b.sessionVariables.newViewportMaximum = b.viewportMaximum - f, g = !0); else if ((!e || 2 < Math.abs(d)) && (!f || 2 < Math.abs(b)) && this.zoomEnabled) {
    ...
    v.prototype._plotAreaMouseMove = function (a, c) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if ((!e || 2 < Math.abs(b) || !f || 2 < Math.abs(d)) && (this.panEnabled || this.zoomEnabled))if (this.panEnabled)e = {
                ...
                e.y1, e.x2, e.y2, !0) && (this._dispatchRangeEvent("rangeChanging", "pan"), this.render(), this._dispatchRangeEvent("rangeChanged", "pan"), this.dragStartPoint.x = a, this.dragStartPoint.y = c); else if (this.zoomEnabled) {
                this.resetOverlayedCanvas();
                b = this.overlaidCanvasCtx.globalAlpha;
                this.overlaidCanvasCtx.fillStyle = "#A89896";
                var d = e ? this.dragStartPoint.x : this.plotArea.x1, g = f ? this.dragStartPoint.y : this.plotArea.y1, k = e ? a - this.dragStartPoint.x : this.plotArea.x2 - this.plotArea.x1, q = f ? c - this.dragStartPoint.y : this.plotArea.y2 -
                this.plotArea.y1;
    ...
    v.prototype._zoomPanToSelectedRegion = function (a, c, b, d, e) {
        ...
        b = a.axesRanges;
        if (a.isValid)for (d = 0; d < c.length; d++)e = b[d], c[d].setViewPortRange(e.val1, e.val2);
        return a.isValid
    };
    v.prototype.validateRegion = function (a, c, b, d, e) {
        e = e || !1;
        var f = 0 <= this.zoomType.indexOf("x"), g = 0 <= this.zoomType.indexOf("y"), k = !1, q = [], h = [], n = [];
        this.axisX && f && h.push(this.axisX);
        this.axisY && g && h.push(this.axisY);
        this.axisY2 && g && h.push(this.axisY2);
        for (f = 0; f < h.length; f++) {
            var g = h[f], m = g.convertPixelToValue({x: a, y: c}), l = g.convertPixelToValue({x: b, y: d});
            if (m > l)var p = l, l = m, m = p;
            if (isFinite(g.dataInfo.minDiff))if (!(Math.abs(l -
        ...
        return {isValid: k, axesWithValidRange: q, axesRanges: n}
    };
    ...
    v.prototype.renderIndexLabels = function (a) {
        ...
        for (var c = this.plotArea, b = 0, d = 0, e = 0, f = 0, g = b = f = d = e = 0, k = 0, q = 0; q < this._indexLabels.length; q++) {
            var h = this._indexLabels[q], n = h.chartType.toLowerCase(), m, l, p = R("indexLabelFontColor",
                h.dataPoint, h.dataSeries), g = R("indexLabelFontSize", h.dataPoint, h.dataSeries), k = R("indexLabelFontFamily", h.dataPoint, h.dataSeries);
            m = R("indexLabelFontStyle", h.dataPoint, h.dataSeries);
            l = R("indexLabelFontWeight", h.dataPoint, h.dataSeries);
            var f = R("indexLabelBackgroundColor", h.dataPoint, h.dataSeries), d = R("indexLabelMaxWidth", h.dataPoint, h.dataSeries), e = R("indexLabelWrap", h.dataPoint, h.dataSeries), r = R("indexLabelLineDashType", h.dataPoint, h.dataSeries), t = R("indexLabelLineColor", h.dataPoint, h.dataSeries),
                y = x(h.dataPoint.indexLabelLineThickness) ? x(h.dataSeries._options.indexLabelLineThickness) ? 0 : h.dataSeries._options.indexLabelLineThickness : h.dataPoint.indexLabelLineThickness, b = 0 < y ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0, s = {
                    percent: null,
                    total: null
                }, z = null;
            ...
            if (null !== w && "" !== w) {
                var s = R("indexLabelPlacement", h.dataPoint, h.dataSeries), z = R("indexLabelOrientation", h.dataPoint, h.dataSeries), u = h.direction, W = h.dataSeries.axisX, A = h.dataSeries.axisY, v = !1, p = new O(a, {
                    x: 0,
                    y: 0,
                ...
                if ("normal" === this.plotInfo.axisPlacement) {
                    if (0 <= n.indexOf("line") || 0 <= n.indexOf("area"))s = "auto", f = 4; else if (0 <= n.indexOf("stacked"))"auto" === s && (s = "inside"); else if ("bubble" === n || "scatter" === n)s = "inside";
                    m = h.point.x - g / 2;
    ...
    v.prototype.renderLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                var k = g.dataPoints, q = "solid";
                if (c.setLineDash) {
                    var h = D(g.nullDataLineDashType, g.lineThickness), q = g.lineDashType, n = D(q, g.lineThickness);
                    c.setLineDash(n)
                }
                var m = g.id;
                ...
                c.beginPath();
                if (0 < k.length) {
                    for (var s = !1, r = 0; r < k.length; r++)if (t = k[r].x.getTime ? k[r].x.getTime() : k[r].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !s)))if ("number" !== typeof k[r].y)0 < r && !(g.connectNullData || s || p) && (c.stroke(), u && b.stroke()), s = !0; else {
    ...
    v.prototype.renderStepLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (c.setLineDash) {
                    var h =
                        D(g.nullDataLineDashType, g.lineThickness), q = g.lineDashType, n = D(q, g.lineThickness);
                    c.setLineDash(n)
                }
                var m = g.id;
                this._eventManager.objectMap[m] = {objectType: "dataSeries", dataSeriesIndex: f};
                ...
                c.beginPath();
                if (0 < k.length) {
                    for (var s = !1, r = 0; r < k.length; r++)if (t = k[r].getTime ? k[r].x.getTime() : k[r].x, !(t < a.axisX.dataInfo.viewPortMin ||
                        t > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !s)))if ("number" !== typeof k[r].y)0 < r && !(g.connectNullData || s || p) && (c.stroke(), u && b.stroke()), s = !0; else {
                        var z = y;
                        ...
                        this._eventManager.objectMap[w] = {
                            id: w, objectType: "dataPoint",
                            dataSeriesIndex: f, dataPointIndex: r, x1: t, y1: y
                        };
    ...
    v.prototype.renderSpline = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var e = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                var q = k.dataPoints, h = "solid";
                if (b.setLineDash) {
                    var n = D(k.nullDataLineDashType, k.lineThickness), h = k.lineDashType, m = D(h, k.lineThickness);
                    b.setLineDash(m)
                }
                var l = k.id;
                ...
                var l = k._colorSet, p = l = k._options.lineColor ? k._options.lineColor : l[0];
                b.strokeStyle = l;
                var r = 0, t, y, s = [];
                b.beginPath();
                if (0 < q.length)for (y = !1, r = 0; r < q.length; r++)if (t = q[r].getTime ? q[r].x.getTime() :
                        q[r].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !y)))if ("number" !== typeof q[r].y)0 < r && !y && (k.connectNullData ? b.setLineDash && (0 < s.length && (k._options.nullDataLineDashType || !q[r - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = n, h = k.nullDataLineDashType) : (c(s), s = [])), y = !0; else {
                    t = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (t - a.axisX.conversionParameters.minimum) + 0.5 << 0;
            ...
            return {
                ...
                animationCallback: B.xClipAnimation, easingFunction: B.easing.linear, animationBase: 0
            }
        }
    };
    ...
    v.prototype.renderColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, n = a.axisX.dataInfo.minDiff;
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                var h = a.dataSeriesIndexes[d], m = this.data[h], l = m.dataPoints;
                if (0 < l.length)for (var p = 5 < n && m.bevelEnabled ? !0 : !1, e = 0; e < l.length; e++)if (l[e].getTime ? k = l[e].x.getTime() :
                    ...
                    (l[e].indexLabel || m.indexLabel || l[e].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                        ...
                        bounds: {x1: f, y1: Math.min(g, t), x2: r, y2: Math.max(g, t)},
                        color: b
                    })
                }
            }
    ...
    v.prototype.renderStackedColumn = function (a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = [], f = [], g = 0, k, q = a.axisY.conversionParameters.reference +
                a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, g = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, h = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0, n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                var m = a.dataSeriesIndexes[h], l = this.data[m], p = l.dataPoints;
                if (0 < p.length) {
                    var r = 5 < n && l.bevelEnabled ? !0 : !1;
                    c.strokeStyle = "#4572A7 ";
                    for (g = 0; g < p.length; g++)if (b = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[g].y) {
                        ...
                        b = l.dataPointIds[g];
                        this._eventManager.objectMap[b] = {
                            id: b, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: g, x1: t, y1: k,
                            x2: y, y2: s
                        };
                        b = C(b);
                        ...
                        (p[g].indexLabel || l.indexLabel || p[g].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            dataPoint: p[g],
                            dataSeries: l,
                            point: {x: d, y: 0 <= p[g].y ? k : s},
                            direction: 0 <= p[g].y ? 1 : -1,
                            bounds: {x1: t, y1: Math.min(k, s), x2: y, y2: Math.max(k, s)},
                            color: b
                        })
                    }
                }
            ...
            a = Math.min(q, a.axisY.boundingRect.y2);
            return {
                source: c, dest: this.plotArea.ctx, animationCallback: B.yScaleAnimation,
                easingFunction: B.easing.easeOutQuart, animationBase: a
            }
        }
    };
    v.prototype.renderStackedColumn100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = [], f = [], g = 0, k, q = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, g = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, h = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ?
                this.dataPointWidth : 0.15 * this.width << 0, n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                var m = a.dataSeriesIndexes[h], l = this.data[m], p = l.dataPoints;
                if (0 < p.length)for (var r = 5 < n && l.bevelEnabled ? !0 : !1, g = 0; g < p.length; g++)if (b = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(b < a.axisX.dataInfo.viewPortMin ||
    ...
    v.prototype.renderBar = function (a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = 0, f, g,
                k, q = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, h = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < l.length) {
                    ...
                    c.strokeStyle = "#4572A7 ";
                    for (e = 0; e < l.length; e++)if (l[e].getTime ? k = l[e].x.getTime() : k = l[e].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof l[e].y) {
                        ...
                        b = m.dataPointIds[e];
                        this._eventManager.objectMap[b] = {
                            id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: e,
                            x1: t, y1: g, x2: f, y2: r
                        };
                        b = C(b);
                        ...
                        (l[e].indexLabel || m.indexLabel || l[e].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            dataPoint: l[e],
                            dataSeries: m,
                            point: {x: 0 <= l[e].y ? f : t, y: g + (r - g) / 2},
                            direction: 0 <= l[e].y ? 1 : -1,
                            bounds: {x1: Math.min(t, f), y1: g, x2: Math.max(t, f), y2: r},
                            color: b
                        })
                    }
                }
            ...
            return {
                source: c, dest: this.plotArea.ctx, animationCallback: B.xScaleAnimation,
                easingFunction: B.easing.easeOutQuart, animationBase: a
            }
        }
    };
    v.prototype.renderStackedBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = [], f = [], g = 0, k, q = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, g = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, h = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ?
                this.dataPointWidth : 0.15 * this.height << 0, n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < p.length) {
                    var r = 5 < n && l.bevelEnabled ? !0 : !1;
                    c.strokeStyle = "#4572A7 ";
                    for (g = 0; g < p.length; g++)if (b = p[g].x.getTime ? p[g].x.getTime() :
                        ...
                        (p[g].indexLabel || l.indexLabel || p[g].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            direction: 0 <= p[g].y ? 1 : -1,
                            bounds: {x1: Math.min(s, k), y1: t, x2: Math.max(s, k), y2: y},
                            color: b
                        })
                    }
                }
    ...
    v.prototype.renderStackedBar100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = [], f = [], g = 0, k, q = a.axisY.conversionParameters.reference +
                a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, g = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, h = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.height << 0, n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < p.length) {
                    ...
                    for (g = 0; g < p.length; g++)if (b = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[g].y) {
                        ...
                        b = l.dataPointIds[g];
                        this._eventManager.objectMap[b] = {
                            id: b, objectType: "dataPoint", dataSeriesIndex: m,
                            dataPointIndex: g, x1: s, y1: t, x2: k, y2: y
                        };
                        b = C(b);
                        u && M(this._eventManager.ghostCtx, s, t, k, y, b, 0, null, !1, !1, !1, !1);
                        (p[g].indexLabel || l.indexLabel || p[g].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
            ...
            return {
                ...
                animationCallback: B.xScaleAnimation, easingFunction: B.easing.easeOutQuart, animationBase: a
            }
        }
    };
    v.prototype.renderArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                var q = a.dataSeriesIndexes[k], h = this.data[q], n = h.dataPoints, g = h.id;
                ...
                if (0 < n.length) {
                    var w = h._colorSet[l % h._colorSet.length], x = h._options.lineColor || w, v = x;
                    b.fillStyle = w;
                    b.strokeStyle = x;
                    b.lineWidth = h.lineThickness;
                    var A = "solid";
                    if (b.setLineDash) {
                        var H = D(h.nullDataLineDashType, h.lineThickness), A = h.lineDashType, K = D(A, h.lineThickness);
                        b.setLineDash(K)
                    }
                    for (var I = !0; l < n.length; l++)if (t =
                            n[l].x.getTime ? n[l].x.getTime() : n[l].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !I)))if ("number" !== typeof n[l].y)h.connectNullData || (I || m) || c(), I = !0; else {
    ...
    v.prototype.renderSplineArea = function (a) {
        function c() {
            ...
            if (0 < c.length) {
                if (0 < h.lineThickness) {
                    ...
                    for (var g = 0; g < c.length - 3; g += 3)if (b.bezierCurveTo(c[g + 1].x, c[g + 1].y, c[g + 2].x, c[g + 2].y, c[g + 3].x, c[g + 3].y), u && d.bezierCurveTo(c[g + 1].x, c[g + 1].y, c[g + 2].x, c[g + 2].y, c[g + 3].x, c[g + 3].y), c[g + 3].newStrokeStyle || c[g + 3].newLineDashArray)b.stroke(), b.beginPath(), b.moveTo(c[g + 3].x, c[g + 3].y), c[g + 3].newStrokeStyle && (b.strokeStyle = c[g + 3].newStrokeStyle), c[g + 3].newLineDashArray && b.setLineDash(c[g + 3].newLineDashArray);
                    b.stroke()
                }
                b.beginPath();
                b.moveTo(c[0].x, c[0].y);
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                if (0 < n.length) {
                    var z = h._colorSet[m % h._colorSet.length], w = h._options.lineColor || z, x = w;
                    b.fillStyle = z;
                    b.strokeStyle = w;
                    b.lineWidth = h.lineThickness;
                    var v = "solid";
                    if (b.setLineDash) {
                        var A = D(h.nullDataLineDashType, h.lineThickness), v = h.lineDashType, H = D(v, h.lineThickness);
                        b.setLineDash(H)
                    }
                    for (p = !1; m < n.length; m++)if (l =
                            n[m].x.getTime ? n[m].x.getTime() : n[m].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !p)))if ("number" !== typeof n[m].y)0 < m && !p && (h.connectNullData ? b.setLineDash && (0 < s.length && (h._options.nullDataLineDashType || !n[m - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = A, v = h.nullDataLineDashType) : (c(), s = [])), p = !0; else {
    ...
    v.prototype.renderStepArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            u && (d.beginPath(), d.rect(k.x1, k.y1, k.width, k.height), d.clip());
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                var q = a.dataSeriesIndexes[k], h = this.data[q],
                    n = h.dataPoints, g = h.id;
                ...
                if (0 < n.length) {
                    var x = h._colorSet[l % h._colorSet.length], v = h._options.lineColor || x, A = v;
                    b.fillStyle = x;
                    b.strokeStyle = v;
                    b.lineWidth = h.lineThickness;
                    var H = "solid";
                    if (b.setLineDash) {
                        var K = D(h.nullDataLineDashType, h.lineThickness),
                            H = h.lineDashType, I = D(H, h.lineThickness);
                        b.setLineDash(I)
                    }
                    for (; l < n.length; l++)if (t = n[l].x.getTime ? n[l].x.getTime() : n[l].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !w))) {
                        var G = r;
                        ...
                        H !== (n[l].lineDashType || h.lineDashType)) && (c(), A = n[l].lineColor || v, b.strokeStyle = A, b.setLineDash && (n[l].lineDashType ? (H = n[l].lineDashType, b.setLineDash(D(H, h.lineThickness))) : (H = h.lineDashType, b.setLineDash(I)))), G = h.dataPointIds[l], this._eventManager.objectMap[G] = {
                            ...
                            x: p, y: r, ctx: d, type: t.type, size: t.size, color: G,
                            borderColor: G, borderThickness: t.borderThickness
                        })), (n[l].indexLabel || h.indexLabel || n[l].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                            chartType: "stepArea",
                            dataPoint: n[l],
                            dataSeries: h,
    ...
    v.prototype.renderStackedArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, e = [], f = this.plotArea, g = [], k = [], q = [], h = 0, n, m, l, p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) <<
                0, r = this._eventManager.ghostCtx;
            u && r.beginPath();
            b.save();
            u && r.save();
            b.beginPath();
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                k = [];
                h = s.id;
                this._eventManager.objectMap[h] = {objectType: "dataSeries", dataSeriesIndex: y};
                h = C(h);
                r.fillStyle = h;
                if (0 < q.length) {
                    ...
                    for (var K = !0, h = 0; h < q.length; h++) {
                        l = q[h];
                        var I = null, I = 0 <= s.dataPointIndexes[l] ? z[s.dataPointIndexes[l]] :
                        {x: l, y: null};
                        if (!(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax && (!s.connectNullData || !K)))if ("number" !== typeof I.y)s.connectNullData || (K || t) || c(), K = !0; else {
            ...
            u && r.restore();
            return {
                source: b, dest: this.plotArea.ctx, animationCallback: B.xClipAnimation,
    ...
    v.prototype.renderStackedArea100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, e = this.plotArea, f = [], g = [], k = [], q = [], h = 0, n, m, l, p = a.axisY.conversionParameters.reference +
                a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, r = this.dataPointMaxWidth ? this.dataPointMaxWidth : 0.15 * this.width << 0, t = a.axisX.dataInfo.minDiff, t = 0.9 * e.width / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(t) << 0, y = this._eventManager.ghostCtx;
            b.save();
            u && y.save();
            b.beginPath();
            b.rect(e.x1, e.y1, e.width, e.height);
            ...
            for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                k = [];
                if (0 < q.length) {
                    var d = w._colorSet[h % w._colorSet.length], v = w._options.lineColor ||
                        d, A = v;
                    b.fillStyle = d;
                    b.strokeStyle = v;
                    ...
                    for (var G = !0, h = 0; h < q.length; h++) {
                        ...
                        if (!(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax && (!w.connectNullData || !G)))if ("number" !== typeof S.y)w.connectNullData || (G || s) || c(), G = !0; else {
    ...
    v.prototype.renderBubble = function (a) {
        ...
        if (!(0 >= b)) {
            var d = this.plotArea, e = 0, f, g, k = this.dataPointMaxWidth ? this.dataPointMaxWidth : 0.15 * this.width << 0, e = a.axisX.dataInfo.minDiff, b = 0.9 * (d.width / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(e) / b) << 0;
            c.save();
            u && this._eventManager.ghostCtx.save();
            c.beginPath();
            c.rect(d.x1, d.y1, d.width, d.height);
            ...
            for (var q = -Infinity, h = Infinity,
                     n = 0; n < a.dataSeriesIndexes.length; n++)for (var m = a.dataSeriesIndexes[n], l = this.data[m], p = l.dataPoints, r = 0, e = 0; e < p.length; e++)f = p[e].getTime ? f = p[e].x.getTime() : f = p[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof p[e].z || (r = p[e].z, r > q && (q = r), r < h && (h = r));
            for (var t = 25 * Math.PI, d = Math.max(Math.pow(0.25 * Math.min(d.height, d.width) / 2, 2) * Math.PI, t), n = 0; n < a.dataSeriesIndexes.length; n++)if (m = a.dataSeriesIndexes[n], l = this.data[m], p = l.dataPoints, 1 == p.length && (b = k), 1 > b ? b =
                    1 : b > k && (b = k), 0 < p.length)for (c.strokeStyle = "#4572A7 ", e = 0; e < p.length; e++)if (f = p[e].getTime ? f = p[e].x.getTime() : f = p[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[e].y) {
                ...
                var r = p[e].z, y = 2 * Math.max(Math.sqrt((q ===
                            h ? d / 2 : t + (d - t) / (q - h) * (r - h)) / Math.PI) << 0, 1), r = l.getMarkerProperties(e, c);
                r.size = y;
    ...
    v.prototype.renderScatter = function (a) {
        ...
        if (!(0 >= b)) {
            var d = this.plotArea,
                e = 0, f, g, k = this.dataPointMaxWidth ? this.dataPointMaxWidth : 0.15 * this.width << 0, e = a.axisX.dataInfo.minDiff, b = 0.9 * (d.width / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(e) / b) << 0;
            c.save();
            u && this._eventManager.ghostCtx.save();
            c.beginPath();
            c.rect(d.x1, d.y1, d.width, d.height);
            ...
            for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                var h = a.dataSeriesIndexes[q],
                    n = this.data[h], m = n.dataPoints;
                1 == m.length && (b = k);
                1 > b ? b = 1 : b > k && (b = k);
                if (0 < m.length) {
                    c.strokeStyle = "#4572A7 ";
                    Math.pow(0.3 * Math.min(d.height, d.width) / 2, 2);
                    for (var l = 0, p = 0, e = 0; e < m.length; e++)if (f = m[e].getTime ? f = m[e].x.getTime() : f = m[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                        f = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (f - a.axisX.conversionParameters.minimum) + 0.5 << 0;
    ...
    v.prototype.renderCandlestick =
        function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var d = null, d = this.plotArea, e = 0, f, g, k, q, h, n, e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < t.length)for (var y = 5 < m && r.bevelEnabled ? !0 : !1, e = 0; e < t.length; e++)if (t[e].getTime ? n = t[e].x.getTime() : n = t[e].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax) && null !== t[e].y && t[e].y.length && "number" === typeof t[e].y[0] && "number" === typeof t[e].y[1] && "number" === typeof t[e].y[2] && "number" === typeof t[e].y[3]) {
                        ...
                        (t[e].indexLabel || r.indexLabel || t[e].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            point: {x: s + (z - s) / 2, y: k},
                            direction: 1,
                            bounds: {x1: s, y1: Math.min(k, q), x2: z, y2: Math.max(k, q)},
                            color: d
                        })
                    }
                }
                ...
                u && b.restore();
                return {
                    source: c, dest: this.plotArea.ctx, animationCallback: B.fadeInAnimation,
    ...
    v.prototype.renderRangeColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                var h = a.dataSeriesIndexes[q], n = this.data[h], m = n.dataPoints;
                if (0 < m.length)for (var l = 5 < k && n.bevelEnabled ? !0 : !1, e = 0; e < m.length; e++)if (m[e].getTime ? g = m[e].x.getTime() : g = m[e].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && null !== m[e].y && m[e].y.length && "number" === typeof m[e].y[0] && "number" === typeof m[e].y[1]) {
                    b =
                    ...
                    var p = b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount + q) * k << 0, r = p + k << 0, b = m[e].color ?
                    ...
                    if (m[e].indexLabel || n.indexLabel || m[e].indexLabelFormatter || n.indexLabelFormatter)this._indexLabels.push({
                        ...
                        point: {
                            x: p +
                            (r - p) / 2, y: m[e].y[1] >= m[e].y[0] ? f : d
                        },
                        direction: m[e].y[1] >= m[e].y[0] ? -1 : 1,
                        bounds: {x1: p, y1: Math.min(d, f), x2: r, y2: Math.max(d, f)},
                        color: b
                    }), this._indexLabels.push({
                        chartType: "rangeColumn",
                        dataPoint: m[e],
                        dataSeries: n,
                        indexKeyword: 1,
                        point: {x: p + (r - p) / 2, y: m[e].y[1] >= m[e].y[0] ? d : f},
                        direction: m[e].y[1] >= m[e].y[0] ? 1 : -1,
                        bounds: {x1: p, y1: Math.min(d, f), x2: r, y2: Math.max(d, f)},
                        color: b
                    })
    ...
    v.prototype.renderRangeBar = function (a) {
        var c = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, d = this.plotArea, e = 0, f, g, k, e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
            ...
            for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                var n = a.dataSeriesIndexes[h], m = this.data[n], l = m.dataPoints;
                if (0 < l.length) {
                    var p = 5 < q && m.bevelEnabled ? !0 : !1;
                    c.strokeStyle = "#4572A7 ";
                    for (e = 0; e < l.length; e++)if (l[e].getTime ? k = l[e].x.getTime() : k = l[e].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) &&
                        ...
                        if (l[e].indexLabel || m.indexLabel || l[e].indexLabelFormatter || m.indexLabelFormatter)this._indexLabels.push({
                            ...
                            dataSeries: m,
                            indexKeyword: 0,
                            point: {x: l[e].y[1] >= l[e].y[0] ? d : f, y: g + (r - g) / 2},
                            ...
                            dataSeries: m,
                            indexKeyword: 1,
                            point: {x: l[e].y[1] >= l[e].y[0] ? f : d, y: g + (r - g) / 2},
                            direction: l[e].y[1] >= l[e].y[0] ? 1 : -1,
                            bounds: {x1: Math.min(d, f), y1: g, x2: Math.max(d, f), y2: r},
                            color: b
                        })
            ...
            return {
                source: c, dest: this.plotArea.ctx,
                animationCallback: B.fadeInAnimation, easingFunction: B.easing.easeInQuad, animationBase: 0
            }
        }
    };
    v.prototype.renderRangeArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                var g = [], k = a.dataSeriesIndexes[f], q = this.data[k], h = q.dataPoints, e = q.id;
                this._eventManager.objectMap[e] = {objectType: "dataSeries", dataSeriesIndex: k};
                e = C(e);
                d.fillStyle = e;
                var e = [], n = !0, m = 0, l, p, r, t, y = null;
                if (0 < h.length) {
                    var s = q._colorSet[m % q._colorSet.length], z = q._options.lineColor || s, w = z;
                    b.fillStyle = s;
                    b.strokeStyle = z;
                    ...
                    for (var H = !0; m < h.length; m++)if (t = h[m].x.getTime ? h[m].x.getTime() : h[m].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!q.connectNullData || !H)))if (null !==
                        ...
                        n || H ? (q.connectNullData && !n ? (b.setLineDash && (q._options.nullDataLineDashType || x === q.lineDashType && q.lineDashType !== q.nullDataLineDashType) && (g[g.length - 1].newLineDashArray = A, x = q.nullDataLineDashType, b.setLineDash(v)), b.lineTo(l, p), u && d.lineTo(l, p), g.push({
                            x: l,
                            y: r
                        })) : (b.beginPath(), b.moveTo(l, p), y = {x: l, y: p}, g = [], g.push({
                            x: l,
                            y: r
                        ...
                        t = q.dataPointIds[m];
                        this._eventManager.objectMap[t] = {
                            id: t, objectType: "dataPoint", dataSeriesIndex: k,
                            dataPointIndex: m, x1: l, y1: p, y2: r
                        };
    ...
    v.prototype.renderRangeSplineArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            u && (d.beginPath(), d.rect(f.x1, f.y1, f.width, f.height), d.clip());
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                var g = a.dataSeriesIndexes[f], k = this.data[g], q = k.dataPoints, e = k.id;
                this._eventManager.objectMap[e] = {objectType: "dataSeries", dataSeriesIndex: g};
                e = C(e);
                d.fillStyle = e;
                var e = [], h = 0, n, m, l, p = [], r = [];
                if (0 < q.length) {
                    var t = k._colorSet[h % k._colorSet.length], y = k._options.lineColor ||
                        t, s = y;
                    b.fillStyle = t;
                    b.lineWidth = k.lineThickness;
                    var z = "solid", w;
                    if (b.setLineDash) {
                        var x = D(k.nullDataLineDashType, k.lineThickness), z = k.lineDashType;
                        w = D(z, k.lineThickness)
                    }
                    for (m = !1; h < q.length; h++)if (n = q[h].x.getTime ? q[h].x.getTime() : q[h].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !m)))if (null !== q[h].y && q[h].y.length && "number" === typeof q[h].y[0] && "number" === typeof q[h].y[1]) {
    ...
    v.prototype.renderPie = function (a) {
        function c() {
            if (h &&
                ...
                for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                    var f = n[e], g = h.dataPointIds[e], k = {
                        id: g,
                        objectType: "dataPoint",
                        dataPointIndex: e,
                        dataSeriesIndex: 0
                    ...
                    p.push(k);
                    var m = {percent: null, total: null}, r = null, m = q.getPercentAndTotal(h, f);
        ...
        function e(a) {
            for (var b = null, c = 1; c < n.length; c++)if (b = (a + c + p.length) % p.length, p[b].hemisphere !== p[a].hemisphere) {
                b = null;
                break
            } else if (p[b].indexLabelText && b !== a && (0 > d(p[b], p[a]) ||
                ("right" === p[a].hemisphere ? p[b].indexLabelTextBlock.y >= p[a].indexLabelTextBlock.y : p[b].indexLabelTextBlock.y <= p[a].indexLabelTextBlock.y)))break; else b = null;
            return b
        }
        ...
        function f(a, b, c) {
            ...
            if (0 <= a && a < n.length) {
                ...
                h = null;
                for (k = 1; k < n.length; k++)if (h = (a - k + p.length) % p.length, p[h].hemisphere !== p[a].hemisphere) {
                    h = null;
                    break
                } else if (p[h].indexLabelText && p[h].hemisphere === p[a].hemisphere && h !== a && (0 > d(p[h], p[a]) || ("right" === p[a].hemisphere ? p[h].indexLabelTextBlock.y <= p[a].indexLabelTextBlock.y : p[h].indexLabelTextBlock.y >= p[a].indexLabelTextBlock.y)))break; else h = null;
                q = h;
                m = e(a);
                k = h = 0;
        ...
        function g() {
            ...
            for (var b = a = 0, c = 0, g = !0, b =
                ...
                (function () {
                    ...
                    n.length; g++)if (f = !1, s = p[g], s.indexLabelText) {
                        var k = e(g);
                        if (null !== k) {
                            var h = p[k];
                            B = 0;
                            ...
                            if (l = 0 > B) {
                                ...
                                var q = s.indexLabelTextBlock.y - s.indexLabelTextBlock.height / 2, r = s.indexLabelTextBlock.y + s.indexLabelTextBlock.height / 2, t = h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2, u = h.indexLabelTextBlock.x + h.indexLabelTextBlock.width, y = h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2;
        ...
        function k() {
            ...
            if (q.subtitles)for (var a = 0; a < q.subtitles.length; a++) {
                var b = q.subtitles[a];
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            a = !1;
            for (var B = 0; B < n.length; B++)v += Math.abs(n[B].y), !a && ("undefined" !== typeof n[B].indexLabel && null !== n[B].indexLabel && 0 < n[B].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof n[B].label && null !== n[B].label && 0 < n[B].label.toString().length) && (a = !0);
            if (0 !== v) {
                ...
                var H = "undefined" !== typeof h.innerRadius && null !== h.innerRadius ? Ha(h.innerRadius, A) : 0.7 * A, K = Math.min(H / A, (A - 1) / A);
                ...
                this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
                    ...
                    for (b = 0; b < n.length; b++) {
                        var c = 0 === b ? p[b].startAngle : d, d = c + (p[b].endAngle -
                            p[b].startAngle), e = !1;
                        d > a && (d = a, e = !0);
    ...
    O.prototype._wrapText = function () {
        var a = new String(ea(String(this.text))), c = [], b = this.ctx.font,
            d = 0, e = 0;
        ...
        this._wrappedText = {lines: c, width: e, height: d};
    ...
    ga.prototype.render = function () {
        if (this.text) {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, c = a.layoutManager.getFreeSpace(), b = c.x1, d = c.y1, e = 0, f = 0, g = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, k, q;
    ...
    oa.prototype.render = function () {
        var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, c = a.layoutManager.getFreeSpace(), b = null, d = 0, e = 0, f = 0, g = 0, k = this.chart._options.legend && !x(this.chart._options.legend.markerMargin) ? this.chart._options.legend.markerMargin : 0.3 * this.fontSize;
        this.height = 0;
        var q = [], h = [];
        ...
        for (var n = 0; n < this.dataSeries.length; n++) {
            ...
            if ("pie" !== m.type && "doughnut" !== m.type && "funnel" !== m.type) {
                ...
                "spline" !== m.type && "scatter" !== m.type && "bubble" !== m.type || !m.markerType ? Y.getDefaultLegendMarker(m.type) : m.markerType, p = m.legendText ? m.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                    chart: this.chart._publicChartReference,
                    legend: this._options,
                    dataSeries: m,
                    dataPoint: null
                }) : m.name, r = m.legendMarkerColor ? m.legendMarkerColor : m.markerColor ? m.markerColor : m._colorSet[0], t = m.markerSize || "line" !== m.type && "stepLine" !== m.type && "spline" !== m.type ? 0.75 * this.lineHeight : 0, u = m.legendMarkerBorderColor ? m.legendMarkerBorderColor :
                    m.markerBorderColor, s = m.legendMarkerBorderThickness ? m.legendMarkerBorderThickness : m.markerBorderThickness ? Math.max(1, Math.round(0.2 * t)) : 0, p = this.chart.replaceKeywordsWithValue(p, m.dataPoints[0], m, n), l = {
                    markerType: l,
                    markerColor: r,
                    text: p,
                    textBlock: null,
                ...
                q.push(l)
            } else for (var v = 0; v < m.dataPoints.length; v++) {
                var w = m.dataPoints[v], l = w.legendMarkerType ? w.legendMarkerType :
                    m.legendMarkerType ? m.legendMarkerType : Y.getDefaultLegendMarker(m.type), p = w.legendText ? w.legendText : m.legendText ? m.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                    chart: this.chart._publicChartReference,
                    legend: this._options,
                    dataSeries: m,
                    dataPoint: w
                }) : w.name ? w.name : "DataPoint: " + (v + 1), r = w.legendMarkerColor ? w.legendMarkerColor : m.legendMarkerColor ? m.legendMarkerColor : w.color ? w.color : m.color ? m.color : m._colorSet[v % m._colorSet.length], t = 0.75 * this.lineHeight, u = w.legendMarkerBorderColor ? w.legendMarkerBorderColor :
                    m.legendMarkerBorderColor ? m.legendMarkerBorderColor : w.markerBorderColor ? w.markerBorderColor : m.markerBorderColor, s = w.legendMarkerBorderThickness ? w.legendMarkerBorderThickness : m.legendMarkerBorderThickness ? m.legendMarkerBorderThickness : w.markerBorderThickness || m.markerBorderThickness ? Math.max(1, Math.round(0.2 * t)) : 0, p = this.chart.replaceKeywordsWithValue(p, w, m, v), l = {
                    markerType: l,
                    markerColor: r,
                    text: p,
                    textBlock: null,
    ...
    Y.prototype.getDataPointAtX = function (a, c) {
        ...
        var b = {
            ...
            distance: Infinity,
            index: NaN
        }, d = null, e = 0, f = 0, g = 1, k = Infinity, q = 0, h = 0, n = 0;
    ...
    Y.prototype.getDataPointAtXY = function (a, c, b) {
        ...
        b = b || !1;
        var d = [], e = 0, f = 0, g = 1, k = !1, q = Infinity, h = 0, n = 0, m = 0;
        ...
        for (; ;) {
            f = 0 < g ? m + e : m - e;
            if (0 <= f && f < this.dataPoints.length) {
                var l = this.chart._eventManager.objectMap[this.dataPointIds[f]], p = this.dataPoints[f], r =
                    null;
                if (l) {
                    switch (this.type) {
                        case "column":
                        ...
                        case "scatter":
                            var t =
                                R("markerSize", p, this) || 4, u = b ? 20 : t, r = Math.sqrt(Math.pow(l.x1 - a, 2) + Math.pow(l.y1 - c, 2));
                        ...
                        case "candlestick":
                            if (a >= l.x1 - l.borderThickness / 2 && a <= l.x2 + l.borderThickness / 2 && c >= l.y2 - l.borderThickness / 2 && c <= l.y3 + l.borderThickness / 2 || Math.abs(l.x2 - a + l.x1 - a) < l.borderThickness && c >= l.y1 && c <= l.y4)d.push({
                                dataPoint: p, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(l.x1 -
                ...
                m + e >= this.dataPoints.length)break;
            -1 === g ? (e++, g = 1) : g = -1
        }
        a = null;
    ...
    F.prototype.createLabels = function () {
        var a, c, b = 0, b = 0, d, e = 0, f = 0, g = 0, k = 0, q = 0;
        ...
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType)for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), d = za(new Date(this.viewportMaximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < d; za(b, this.interval, this.intervalType))a = b.getTime(), a = this.labelFormatter ? this.labelFormatter({
            chart: this.chart._publicChartReference,
            axis: this._options, value: b, label: this.labels[b] ? this.labels[b] : null
            ...
            position: b.getTime(),
            textBlock: a, effectiveHeight: null
        }); else {
            d = this.viewportMaximum;
            if (this.labels && this.labels.length) {
                a = Math.ceil(this.interval);
                for (var h = Math.ceil(this.intervalStartPosition), f = !1, b = h; b < this.viewportMaximum; b += a)if (this.labels[b])f = !0; else {
                    f = !1;
                    break
                }
            ...
            for (b = this.intervalStartPosition; b <= d; b = parseFloat((b + this.interval).toFixed(14)))a = this.labelFormatter ? this.labelFormatter({
                chart: this.chart._publicChartReference, axis: this._options, value: b, label: this.labels[b] ?
                    this.labels[b] : null
        ...
        } else for (b = 0; b < this._labels.length; b++)a = this._labels[b].textBlock, a.maxWidth = this.labelMaxWidth = x(this._options.labelMaxWidth) ? this.sessionVariables.labelMaxWidth :
        ...
        "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0, g = "outside" === c.labelPlacement ? x(c._options.labelBackgroundColor) ? "#EEEEEE" : c._options.labelBackgroundColor : x(c._options.labelBackgroundColor) ? c.startValue ? "#EEEEEE" : "transparent" : c._options.labelBackgroundColor, a = new O(this.ctx, {
            ...
            textBaseline: "middle",
            borderThickness: 0
        }), this._stripLineLabels.push({position: c.value, textBlock: a, effectiveHeight: null, stripLine: c})
    };
    F.prototype.createLabelsAndCalculateWidth = function () {
        ...
        if ("left" === this._position || "right" === this._position) {
            ...
            for (c = 0; c < this._labels.length; c++) {
                var b =
                    this._labels[c].textBlock, d = b.measureText(), e = 0, e = 0 === this.labelAngle ? d.width : d.width * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) + (d.height - b.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
                a < e && (a = e);
    ...
    F.prototype.createLabelsAndCalculateHeight = function () {
        ...
        if ("bottom" === this._position || "top" === this._position) {
            for (b = 0; b < this._labels.length; b++) {
                ...
                var d = c.measureText(), e = 0, e = 0 === this.labelAngle ? d.height :
    ...
    F.setLayoutAndRender = function (a, c, b, d, e) {
        ...
        if ("normal" === d) {
            ...
            for (; 4 > l++;) {
                ...
                {x1: g, y1: d, x2: g, y2: k, height: Math.abs(k - d)}, c.boundingRect = {
                    x1: f,
                    y1: d,
                    x2: g,
                    y2: k,
                ...
                if (a || c || b) {
                    if (!x(G))for (l = 0; l < G.length; l++)for (j = l + 1; j < G.length; j++)G[l] == G[j] && (D = !0);
                    if (!x(F))for (l = 0; l < F.length; l++)for (j = l + 1; j < F.length; j++)F[l] == F[j] && (E = !0);
                    if (!x(J))for (l = 0; l < J.length; l++)for (j = l + 1; j < J.length; j++)J[l] == J[j] && (I = !0)
                }
                if (D && E && I)break
            }
            h.save();
            ...
            for (; 4 > l++;) {
                ...
                b && b.calculateValueToPixelConversionParameters();
                if (a || c || b) {
                    if (!x(G))for (l = 0; l < G.length; l++)for (j =
    ...
    F.prototype.renderInterlacedColors = function () {
        ...
        c = !0;
        if (("bottom" === this._position || "top" === this._position) && this.interlacedColor)for (a.fillStyle = this.interlacedColor, e = 0; e < this._labels.length; e++)this._labels[e].stripLine || (c ? (c = this.getPixelCoordinatesOnAxis(this._labels[e].position),
    ...
    F.prototype.renderStripLinesOfThicknessType = function (a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            ...
            for (d = 0; d < this._stripLineLabels.length; d++)if (e = this.stripLines[d], b = this._stripLineLabels[d], !(b.position < this.viewportMinimum || b.position > this.viewportMaximum))if (a = this.getPixelCoordinatesOnAxis(b.position), "outside" === b.stripLine.labelPlacement) {
    ...
    F.prototype.renderGrid = function () {
        if (this.gridThickness && 0 < this.gridThickness) {
            ...
            if ("bottom" === this._position || "top" === this._position)for (d =
    ...
    F.prototype.calculateAxisParameters = function () {
        ...
        var a = "axisX" === this.type ? 500 > this.maxWidth ? 8 : Math.max(6, Math.floor(this.maxWidth / 62)) : Math.max(Math.floor(this.maxWidth / 40), 2), b, d,
            e, f;
        f = 0;
    ...
    pa.prototype.render = function () {
        this.ctx.save();
        var a = this.parent.getPixelCoordinatesOnAxis(this.value), c = Math.abs("pixel" === this._thicknessType ? this.thickness : this.parent.conversionParameters.pixelPerUnit * this.thickness);
        if (0 < c) {
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position)e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, g = this.chart.plotArea.y1, k = this.chart.plotArea.y2; else if ("left" === this.parent._position || "right" === this.parent._position)g = k = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0,
    ...
    V.prototype._updateToolTip = function (a, c) {
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared &&
                ...
                if (g = this.chart.getDataPointAtXY(a, c, !0))this.currentDataPointIndex = g.dataPointIndex, this.currentSeriesIndex = g.dataSeries.index; else if (u)if (g = Ea(a, c, this.chart._eventManager.ghostCtx), 0 < g && "undefined" !== typeof this.chart._eventManager.objectMap[g]) {
                ...
                if (0 <= this.currentSeriesIndex) {
                    ...
                    if (0 <= this.currentDataPointIndex)b = d.dataPoints[this.currentDataPointIndex], g.dataSeries = d, g.dataPoint = b, g.index = this.currentDataPointIndex,
                        g.distance = Math.abs(b.x - f); else {
                    ...
                    if (!x(g.dataPoint.y))if (g.dataSeries.axisY)if (0 < g.dataPoint.y.length) {
    ...
    V.prototype.getToolTipInnerHTML = function (a) {
        a = a.entries;
        for (var c = null, b = null, d = null, e = 0, f = "", g = !0, k = 0; k < a.length; k++)if (a[k].dataSeries.toolTipContent || a[k].dataPoint.toolTipContent) {
            g = !1;
            break
        }
        if (g && (this.content && "function" === typeof this.content || this.contentFormatter))a = {
            ...
            for (var q = "", k = 0; k < a.length; k++)if (b = a[k].dataSeries, d = a[k].dataPoint, e = a[k].index, f = "", 0 === k && (g && !this.content) && (q += "undefined" !== typeof this.chart.axisX.labels[d.x] ? this.chart.axisX.labels[d.x] : "{x}", q += "</br>", q = this.chart.replaceKeywordsWithValue(q, d, b, e)), null !== d.toolTipContent && ("undefined" !== typeof d.toolTipContent || null !== b._options.toolTipContent)) {
                if ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "area" === b.type ||
                    ...
                    "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y[0]},&nbsp;{y[1]}"; else if ("candlestick" === b.type || "ohlc" === b.type)f += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low:&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}";
                null === c && (c = "");
    ...
    v.prototype.getPercentAndTotal = function (a, c) {
        ...
        if (0 <= a.type.indexOf("stacked"))d = 0, b = c.x.getTime ? c.x.getTime() : c.x, b in a.plotUnit.yTotals && (d = a.plotUnit.yTotals[b], e = isNaN(c.y) ? 0 : 0 === d ? 0 : 100 * (c.y / d)); else if ("pie" === a.type || "doughnut" === a.type) {
    ...
    v.prototype.replaceKeywordsWithValue = function (a, c, b, d, e) {
        ...
        if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
            var g = "#percent", k = "#total", q = this.getPercentAndTotal(b, c), k = isNaN(q.total) ? k : q.total, g = isNaN(q.percent) ? g : q.percent;
            do {
                q = "";
                if (b.percentFormatString)q = b.percentFormatString; else {
                    var q = "#,##0.", h = Math.max(Math.ceil(Math.log(1 / Math.abs(g)) / Math.LN10), 2);
    ...
    va.prototype.animate = function (a, c, b, d, e) {
        ...
        for (a = []; 0 < this.animations.length;)if (c = this.animations.shift(), b = (new Date).getTime(), d = 0, c.startTime <= b && (d = e(Math.min(b - c.startTime,
